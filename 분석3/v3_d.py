...
widths(w0,[26,70,24])
title(w0,1,'수출입 실적 통합 분석 (2024.01 ~ 2026.07, 31개월) — 월별 분해판',3)
note(w0,2,1,'업로드하신 5개 원본 파일을 한 파일로 모으고, 원본은 수정하지 않은 채 분석 시트를 추가했습니다. 모든 증감 분석은 1~7월 누계가 아니라 각 달을 전년 동월과 비교하는 방식입니다.',3)
r=4
...
ROWS0=[('수출입 총괄 외 4개','원본 5개 시트 (총괄·품목별·성질별 수출·성질별 수입·신성질별)','원본 · 수정 없음'),
 ...
 ('분석13_월별변화요약','한 행이 한 달 — 그 달의 증감 주도 품목 상위 3개와 몫','★ 신규')]
for a,b,c in ROWS0:
    put(w0,r,1,a,bold=True); put(w0,r,2,b); put(w0,r,3,c,align='center'); r+=1
r+=1
sec(w0,r,'이번 판에서 달라진 점',3); r+=1
for t in ['① 모든 증감 분석을 1~7월 누계에서 월별 비교로 전환 (분석5·6·7·8·9)',
